...
class PersonControllerTest {
    ...
    void createPerson() throws Exception {
        mockMvc.perform(
                ...
                status().isOk(),
                content().string(Matchers.containsString("Success create " +
                        "person Arief Karditya Hermawan "+ "with email " +
                        "arief@contoh.com and phone 089699669999" +
